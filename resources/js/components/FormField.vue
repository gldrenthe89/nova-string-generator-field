        ...
        <template slot="field">
            <div style="display: flex">
                <input :id="field.name"
                       ...
                       v-model="value"
                />
                <input type="button" class="btn btn-default btn-primary ml-3 cursor-pointer" value="Generate" v-on:click="generate();">
                <input type="button" class="btn btn-default btn-icon ml-3 cursor-pointer" value="Copy" v-on:click="copyPassword();">
            </div>
    ...
    methods: {
        ...
        copyPassword() {
            ...
            if (copyText.value.length > 0) {
                ...
                tooltip.innerHTML = "Generate a string first";
            }
        },
        /*
